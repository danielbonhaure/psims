...
parser.add_option("-t", "--tapp", dest = "tapp", default = None, type = "string",
                  help = "Translator app with options")
parser.add_option("-c", "--co2file", dest = "co2file", default = None, type = "string",
                  help = "csv file containing co2 (optional)", metavar = "FILE")
...
lat, lon = infile.variables['latitude'][0], infile.variables['longitude'][0]
